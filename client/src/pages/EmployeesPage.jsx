    ...
    <div className="page-shell-premium animate-fade-in">
      ...
      <main className="clinical-card !p-0 overflow-hidden">
        <div className="p-6 border-b border-slate-50 flex items-center justify-between">
           <div>
              <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest">Personnel Ledger</h3>
              <p className="text-[10px] font-bold text-slate-400 mt-1 uppercase">Institutional Workforce Node</p>
           </div>
           <button 
             className="clinical-btn bg-emerald-600 text-white px-8 !min-h-[44px] rounded-xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-100 hover:bg-emerald-700 transition-all border-none"
             onClick={() => setShowRegModal(true)}
           >
              <UserPlus className="w-4 h-4 mr-3" /> Provision Node
           </button>
        </div>
